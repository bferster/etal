...
class App  {																					
	...
	constructor()   																			// CONSTRUCTOR
	{
		...
		this.secs=0;																				// Time
		if (window.location.host == "localhost") this.ws=new WebSocket('ws://'+window.location.host+':8080?hello');	// Open insecure websocket											
		else									 this.ws=new WebSocket('wss://'+window.location.host+':8080?hello');	// Secure											
